...
public class MyContentProvider extends ContentProvider {
    ...
    public boolean onCreate() {
        ...
        //参数：代表无法匹配
        //     content://com.demo.provider/helloworld
        matcher = new UriMatcher(UriMatcher.NO_MATCH);
        matcher.addURI("com.demo.provider","helloworld",1000);
        matcher.addURI("com.demo.provider","helloworld/abc",1001);
        matcher.addURI("com.demo.provider","helloworld/#",1002);
        matcher.addURI("com.demo.provider","nihaoshijie/*",1003);
