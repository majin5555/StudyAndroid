    ...
    public void operate(View v) {
        ...
        switch (v.getId()) {
            ...
            case R.id.mather_btn:
                resolver.delete(Uri.parse("content://com.demo.provider/helloworld"), null, null);
                resolver.delete(Uri.parse("content://com.demo.provider/helloworld/abc"), null, null);
                resolver.delete(Uri.parse("content://com.demo.provider/helloworld/123"), null, null);
                resolver.delete(Uri.parse("content://com.demo.provider/helloworld/090"), null, null);
                resolver.delete(Uri.parse("content://com.demo.provider/helloworld/89ii"), null, null);
                resolver.delete(Uri.parse("content://com.demo.provider/nihaoshijie/ab90"), null, null);
                break;
            case R.id.uri_btn:
                Uri uri1 = resolver.insert(Uri.parse("content://com.demo.provider/whatever?name=" + name + "&age" + age + "=&gender=" + gender + ""),
                        new ContentValues());
